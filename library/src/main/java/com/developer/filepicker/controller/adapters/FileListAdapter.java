...
public class FileListAdapter extends BaseAdapter {
	...
	public View getView(final int i, View view, ViewGroup viewGroup) {
		...
		if (item.isDirectory()) {
			...
			if (properties.selection_type == DialogConfigs.FILE_SELECT|| properties.selection_type == DialogConfigs.CURRENT_DIR_SELECT) {
			...
			if (properties.selection_type == DialogConfigs.DIR_SELECT || properties.selection_type == DialogConfigs.CURRENT_DIR_SELECT) {
				holder.checkbox.setVisibility(View.INVISIBLE);
			} else {
				holder.checkbox.setVisibility(View.VISIBLE);
			}
